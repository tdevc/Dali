...
ls=reg2.RunCmd("device read 1")        #FW version
FW_version=ShowReturnListHex(ls)                #get FW version

        
print("VCResult:{0};{1};{2}".format(VCM_low,VCM_high,FW_version))    #sent serial number to log file
